...
import { Download, Event, GitHub, LibraryBooks, LinkedIn, Message, WhatsApp } from "@mui/icons-material";
                        ...
                        >
                          ...
                          <Media body className="ml-3">
                            <h5 className="heading text-primary mb-md-1">
                              Transaction Service | Event-Driven
                            </h5>
                            <p className="description d-none d-md-inline-block mb-0">
                              Basic demo of Event-Drive archtecture with NestJs with commented code
                            </p>
                          </Media>
                        </Media>
                        <Media
                          className="d-flex align-items-center"
                          href="https://www.npmjs.com/package/mongoose-express-sanitizer"
                          target="_blank"
                        >
                          <div className="icon icon-shape bg-info rounded-circle text-white">
                            <LibraryBooks/>
                          </div>
                          <Media body className="ml-3">
                            <h5 className="heading text-primary mb-md-1">
                              Library NPM | mongoose-express-sanitizer
                            </h5>
                            <p className="description d-none d-md-inline-block mb-0">
                              Basic demo of Event-Drive archtecture with NestJs with commented code
                            </p>
